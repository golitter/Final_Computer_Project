        ...
        <div class="tag-details-content">
            <div class="tag-details-card">
                <div class="tag-header">
                    ...
                    <p class="tag-desc">Total {{ total }} articles</p>
                </div>
                ...
                <div class="article-list">
                    ...
                    <!-- No data prompt -->
                    <el-empty v-if="total === 0" description="No related articles found" />
                </div>
            </div>
        </div>

        <!-- Page footer -->
        <self-footer class="tag-details-footer" />
    </div>
</template>
